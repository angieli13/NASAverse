...
export async function obtenerAsteroids() {
  ...
  try {
    ...
    const url =
`https://api.nasa.gov/neo/rest/v1/feed?start_date=${fechaInicio}&end_date=${fechaFin}&api_key=${API_KEY}`;
    ...
    const asteroides =
      Object.values(datos.near_earth_objects).flat();
    ...
    asteroides.forEach((asteroide) => {
      ...
      <div class="asteroid-card ${esPeligroso ? "peligroso" : ""}">
        ...
        <i class="fa-solid ${
          esPeligroso ? "fa-triangle-exclamation" : "fa-circle-check"
        }"></i>
